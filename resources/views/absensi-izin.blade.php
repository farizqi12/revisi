...
<body>
    ...
    <div class="main-container">
        ...
        <div class="row">
            <!-- Card Izin Berpergian -->
            <div class="col-md-6 mb-4">
                <div class="location-card">
                    <h2 class="location-title">
                        <i class="fas fa-plane-departure"></i> Izin Berpergian
                    </h2>
                    <div class="mb-3">
                        ...
                        <div class="info-item">
                            Ajukan izin berpergian jika Anda tidak dapat hadir karena keperluan tertentu.
                        </div>
                    </div>
                    <form method="POST" action="{{ route('absen.izin.store') }}" onsubmit="showLoading()">
                        @csrf
                        <input type="hidden" name="type" value="izin">
                        <div class="mb-3">
                            <label for="alasan_berpergian" class="form-label">Alasan Berpergian</label>
                            <textarea class="form-control" id="alasan_berpergian" name="alasan" rows="3" required></textarea>
                        </div>
                        <button type="submit" class="attendance-btn w-100">
                            <i class="fas fa-paper-plane"></i> Ajukan Izin Berpergian
                        </button>
                    </form>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="location-card">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="info-item">
                            Ajukan izin sakit jika Anda tidak dapat hadir karena alasan kesehatan.
                        </div>
                    </div>
                    <form method="POST" action="{{ route('absen.izin.store') }}" enctype="multipart/form-data"
                        onsubmit="showLoading()">
                        @csrf
                        <input type="hidden" name="type" value="sakit">
                        <div class="mb-3">
                            <label for="alasan_sakit" class="form-label">Alasan Sakit</label>
                            <textarea class="form-control" id="alasan_sakit" name="alasan" rows="3" required></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="bukti_sakit" class="form-label">Upload Surat/Bukti Sakit (opsional)</label>
                            <input class="form-control" type="file" id="bukti_sakit" name="bukti">
                        </div>
                        <button type="submit" class="attendance-btn w-100">
                            <i class="fas fa-paper-plane"></i> Ajukan Izin Sakit
                        </button>
                    </form>
                </div>
            </div>
    ...
    <!-- Loading Modal -->
    <div class="loading" id="loadingModal" style="display: none;">
    ...
    <!-- Script untuk tampilkan loading -->
    <script>
